...
`);
    ...
    var Iu = /* @__PURE__ */ Symbol.for("@ts-pattern/isVariadic");
...
Details: ${t.message}`;
    ...
    function Kt({ rootEnvPath: e, schemaEnvPath: t }, r = { conflictCheck: "none" }) {
      ...
      let i = null;
      return us(n == null ? void 0 : n.path, t) || (i = ls(t)), !n && !i && gi("No Environment variables loaded"), (i == null ? void 0 : i.dotenvResult.error) ? console.error(pe(H("Schema Env Error: ")) + i.dotenvResult.error) : { message: [n == null ? void 0 : n.message, i == null ? void 0 : i.message].filter(Boolean).join(`
`), parsed: { ...(_a2 = n == null ? void 0 : n.dotenvResult) == null ? void 0 : _a2.parsed, ...(_b = i == null ? void 0 : i.dotenvResult) == null ? void 0 : _b.parsed } };
    }
    function fc(e, t, r) {
      let n = e == null ? void 0 : e.dotenvResult.parsed, i = !us(e == null ? void 0 : e.path, t);
...
Env vars from ${Z(l)} overwrite the ones from ${Z(a)}
    ...
    function Yt(e) {
      let t = hc();
      return t || ((e == null ? void 0 : e.config.engineType) === "library" ? "library" : (e == null ? void 0 : e.config.engineType) === "binary" ? "binary" : cs);
    }
    function hc() {
...
`);
    ...
    function $p(e, t) {
      ...
      if (o && ((_b = o.getField(n)) == null ? void 0 : _b.markAsError(), i)) for (let s of i.fields) s.isRelation && o.addSuggestion(new ce(s.name, "true"));
      t.addErrorMessage((s) => {
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    function Gp(e, t) {
      ...
      n && ((_b = n.getField(r)) == null ? void 0 : _b.markAsError(), td(n, e.arguments)), t.addErrorMessage((i) => Ys(i, r, e.arguments.map((o) => o.name)));
    }
    function Jp(e, t) {
      var _a2, _b, _c2;
...
`);
    ...
    var xn = class {
      ...
      getAllComputedFields(t) {
        return this.computedFieldsCache.getOrCreate(t, () => {
          var _a2;
          return sa((_a2 = this.previous) == null ? void 0 : _a2.getAllComputedFields(t), this.extension, t);
        });
      }
    ...
    var ba = /* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom");
    function Ae(e, t) {
...
`);
    ...
    function Fa({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
      return n.isEmpty() || e == null || typeof e != "object" || !i.models[t] ? e : An({ result: e, args: r ?? {}, modelName: t, runtimeDataModel: i, visitor: (a, l, u) => {
        let c = Re(l);
        return Na({ result: a, modelName: c, select: u.select, omit: u.select ? void 0 : { ...o == null ? void 0 : o[c], ...u.omit }, extensions: n });
      } });
    }
    function Ma(e) {
    ...
    function qa(e, t, r, n = 0) {
      return e._createPrismaPromise((i) => {
        ...
        return "transaction" in t && i !== void 0 && (((_a2 = t.transaction) == null ? void 0 : _a2.kind) === "batch" && t.transaction.lock.then(), t.transaction = i), n === r.length ? e._executeRequest(t) : r[n]({ model: t.model, operation: t.model ? t.action : t.clientMethod, args: Ma(t.args ?? {}), __internalParams: t, query: (s, a = t) => {
...
`);
    ...
    function sl({ version: e, binaryTarget: t, title: r, description: n, engineVersion: i, database: o, query: s }) {
      var _a2;
      let a = Oo(6e3 - ((s == null ? void 0 : s.length) ?? 0)), l = nl((0, Zi.default)(a)), u = n ? `# Description
\`\`\`
${n}
...
`;
    ...
    function ul(e) {
      var _a2;
      if (!!((_a2 = e.generator) == null ? void 0 : _a2.previewFeatures.some((r) => r.toLowerCase().includes("metrics")))) throw new R("The `metrics` preview feature is not yet available with Accelerate.\nPlease remove `metrics` from the `previewFeatures` in your schema.\n\nMore information about Accelerate: https://pris.ly/d/accelerate", e.clientVersion);
    }
    function um(e) {
...
${r}`, A(n, true));
    ...
    var ao = /* @__PURE__ */ Symbol("PrismaLibraryEngineCache");
    function fm() {
      let e = globalThis;
...
You may have to run ${Ve("prisma generate")} for your changes to take effect.`, this.config.clientVersion);
      ...
      async request(t, { traceparent: r, interactiveTransaction: n }) {
        ...
        try {
          ...
          if (s.code === "GenericFailure" && ((_b = s.message) == null ? void 0 : _b.startsWith("PANIC:"))) throw new ue(po(this, s.message), this.config.clientVersion);
...
${a.backtrace}`, { clientVersion: this.config.clientVersion });
    ...
    function po(e, t) {
      var _a2;
      return sl({ binaryTarget: e.binaryTarget, title: t, version: e.config.clientVersion, engineVersion: (_a2 = e.versionInfo) == null ? void 0 : _a2.commit, database: e.config.activeProvider, query: e.lastQuery });
    }
...
`);
    ...
    function go(e) {
      return function(r) {
        let n, i = (o = e) => {
          try {
            return o === void 0 || (o == null ? void 0 : o.kind) === "itx" ? n ??= Ol(r(o)) : Ol(r(o));
          } catch (s) {
    ...
    var qn = class {
      constructor(t, r) {
        this.logEmitter = r, this.client = t, this.dataloader = new $n({ batchLoader: ja(async ({ requests: n, customDataProxyFetch: i }) => {
          ...
          var _a2;
          let i = ((_a2 = n.transaction) == null ? void 0 : _a2.kind) === "itx" ? Ml(n.transaction) : void 0, o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Eo(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
          return this.mapQueryEngineResult(n, o);
        }, batchBy: (n) => {
          var _a2;
          return ((_a2 = n.transaction) == null ? void 0 : _a2.id) ? `transaction-${n.transaction.id}` : Nl(n.protocolQuery);
        }, batchOrder(n, i) {
          var _a2, _b;
...
${n}`;
    ...
    var $m = /* @__PURE__ */ Symbol.for("prisma.client.transaction.id");
    var qm = { id: 0, nextId() {
      return ++this.id;
    } };
    function Xl(e) {
      class t {
        constructor(n) {
          ...
          this.$extends = _a;
          e = ((_b = (_a2 = n == null ? void 0 : n.__internal) == null ? void 0 : _a2.configOverride) == null ? void 0 : _b.call(_a2, e)) ?? e, Ja(e), n && Jl(n, e);
          let i = new zl.EventEmitter().on("error", () => {
          });
          this._extensions = It.empty(), this._previewFeatures = Ln(e), this._clientVersion = e.clientVersion ?? Vl, this._activeProvider = e.activeProvider, this._globalOmit = n == null ? void 0 : n.omit, this._tracingHelper = kl();
...
var require_client = __commonJS({
  "generated/client/index.js"(exports2) {
    ...
    exports2.Prisma.UserWebsiteScalarFieldEnum = {
      createdAt: "createdAt",
      deletedAt: "deletedAt",
      id: "id",
      userId: "userId",
    ...
    exports2.Prisma.WebsiteScalarFieldEnum = {
      createdAt: "createdAt",
      deletedAt: "deletedAt",
      id: "id",
      url: "url"
    };
    exports2.Prisma.WebsiteTickScalarFieldEnum = {
      createdAt: "createdAt",
      deletedAt: "deletedAt",
      id: "id",
      websiteId: "websiteId",
    ...
    exports2.Prisma.RegionScalarFieldEnum = {
      createdAt: "createdAt",
      deletedAt: "deletedAt",
      id: "id",
      name: "name"
    ...
    exports2.HealthStatus = exports2.$Enums.HealthStatus = {
      UP: "UP",
      DOWN: "DOWN",
      TIMEOUT: "TIMEOUT"
    };
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "/Users/rohitkumarmehta/negativ/open-source/better-uptime/packages/database/generated/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/rohitkumarmehta/negativ/open-source/better-uptime/packages/database/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null
      ...
      "inlineSchemaHash": "55d154a03c526b265d41c330e534ef991e5578268a0dc58009a443bc90539b4f",
      "copyEngine": true
    };
    var fs2 = require("fs");
