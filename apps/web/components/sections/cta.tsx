...
export default function CTA() {
    return <section>
        <Container className="py-6 md:py-12 lg:py-24">
            <div className="flex flex-col md:flex-row gap-4 justify-center border p-4 md:p-8 md:py-12 rounded-md">
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <Button variant="primary" className="px-12 mt-4 w-fit mx-auto md:mx-0">
                        Start for free
                    </Button>
                </div>
